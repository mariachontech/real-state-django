...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+529867236644")
    about_me = models.TextField(verbose_name=_("About Me"), default="Say something about you")
    license = models.CharField(verbose_name=_("Real State License"), max_length=20, blank=True, null=True)
    ...
    top_agent = models.BooleanField(verbose_name=_("Top Agent"), default=False, help_text="Are you a top agent")
